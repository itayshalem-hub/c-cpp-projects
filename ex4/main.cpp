...
//******** End of internal-use defines ********


//******************************************************
//******** The helper functions for runing main ********
//******************************************************
...
int main(int argc, char **argv) {
    ...
    ActFunc activation_funcs[MLP_SIZE] = {activation::relu, activation::relu, activation::relu, activation::softmax};

    MlpNetwork mlp(weights, biases, activation_funcs);
